...
{
	/// <summary>
	/// Represents a node in the text template that iterates over a collection of items.
	/// </summary>
	public class TextTemplateForeachNode : TextTemplateNode
	{
		/// <summary>
		...
		/// <summary>
		/// Creates a new instance of the <see cref="TextTemplateForeachNode"/> class.
		/// </summary>
		...
		public TextTemplateForeachNode(TemplateExpressionNode source, TextTemplateNode child, string iterableName)
		{
